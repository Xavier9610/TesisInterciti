<%@ Page Title="" Language="C#" MasterPageFile="~/Sources/Pages/MPInterciti.Master" AutoEventWireup="true" CodeBehind="frmMarcaCRUD.aspx.cs" Inherits="ASPApp.Sources.Pages.frmMarcaCRUD" %>
            ...
            <div class="col-8">
                <div class="form-control card card-body">
                    ...
                    <fieldset>
                        ...
                        <legend class="row justify-content-center">TIPO</legend>
                        <div class="input-group">
                            <asp:Label runat="server" CssClass="form-control" Text="Tipo:"></asp:Label>
                            <asp:TextBox runat="server" CssClass="form-control" TextMode="SingleLine" ID="txtTipo"></asp:TextBox>
                        </div>
                    </fieldset>
                    <br />
                    <div class="row">
