<%@ Page Title="" Language="C#" MasterPageFile="~/Sources/Pages/MPInterciti.Master" AutoEventWireup="true" CodeBehind="frmModelo.aspx.cs" Inherits="ASPApp.Sources.Pages.frmModelo" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form runat="server" class="container align-content-center">
        ...
        <div class="mx-auto align-content-center" style="width:300px">
            <h2 class="align-content-center">Lista de Modelos</h2>
        </div>
        ...
        <div>
            <asp:GridView ID="grdVCliente" runat="server" AllowPaging="True" HeaderStyle-HorizontalAlign="Center" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="56px" Width="469px" HorizontalAlign="Center" DataSourceID="ObjectDataSource">
                ...
                <Columns>
                   <asp:TemplateField HeaderText="Opciones de administrador">
                    ...
                    <asp:BoundField DataField="Modelo" ItemStyle-HorizontalAlign="Center" HeaderText="Modelo" SortExpression="Modelo" />
            ...
            <asp:ObjectDataSource ID="ObjectDataSource" runat="server" SelectMethod="ListarModeloVehiculo" TypeName="ASPApp.ServiceReferenceInterciti.ServiceClient"></asp:ObjectDataSource>
