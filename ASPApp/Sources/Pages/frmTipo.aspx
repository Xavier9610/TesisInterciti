<%@ Page Title="" Language="C#" MasterPageFile="~/Sources/Pages/MPInterciti.Master" AutoEventWireup="true" CodeBehind="frmTipo.aspx.cs" Inherits="ASPApp.Sources.Pages.frmTipo" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form runat="server" class="container align-content-center">
        ...
        <div>
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Opciones de administrador">
                        ...
                        <button id="bntSelect" onserverclick="bntSelect_Click" runat="server"><i class="fa-solid fa-eye" style="color:forestgreen"></i></button>
                            ...
                            <button id="btnModificar" onserverclick="btnModificar_Click" runat="server"> <i class="fa-solid fa-pen-to-square"  style="color:cornflowerblue"></i></button></ItemTemplate>
                    </asp:TemplateField>
                   <asp:BoundField ItemStyle-HorizontalAlign="Center" DataField="Tipo" HeaderText="Tipo" SortExpression="Tipo" />
                </Columns>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource" runat="server" SelectMethod="ListarTipoVehiculo" TypeName="ASPApp.ServiceReferenceInterciti.ServiceClient"></asp:ObjectDataSource>
