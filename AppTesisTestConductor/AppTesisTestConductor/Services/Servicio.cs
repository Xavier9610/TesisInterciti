...
namespace AppTesisTestConductor.Services
{
    public static class Servicio    {
        ...
        public static Models.Conductor GetLoginCI(string ci,string pass)
        {
           // ServicePointManager.Expect100Continue = true;
            
            Models.Conductor cliente = null;
            //  string passEncryp = client.sha256_hash(pass);
            Models.Conductor clienteQuery =Servicio.WCFToApp( client.FindConductorByCI(ci));
            if (clienteQuery!=null)
            {
                if (Servicio.client.sha256_hash(pass) == clienteQuery.Pass)
                {
                    cliente = new Models.Conductor();
        ...
        //correo
        public static Models.Conductor GetLoginCorreo(string ci, string pass)
        {

            Models.Conductor cliente = null;
            //  string passEncryp = client.sha256_hash(pass);
            Models.Conductor clienteQuery =Servicio.WCFToApp( client.FindConductorByMail(ci));
        ...
        public static ServiceReferenceInterciti.Recorrido AppToWCF(Models.Recorrido clienteQuery)
        {
        ...
        public static ServiceReferenceInterciti.Conductor AppToWCF(Models.Conductor clienteQuery)
        {
            ...
            if (clienteQuery != null)
            {
                ...
                recorrido.Picture = new byte[ImageSourceToBytes(clienteQuery.Picture.Source).Length];
        ...
        public static ServiceReferenceInterciti.Vehiculo AppToWCF(Models.Vehiculo clienteQuery)
        {
            ServiceReferenceInterciti.Vehiculo recorrido = new ServiceReferenceInterciti.Vehiculo();
            if (clienteQuery != null)
            {
                recorrido = new ServiceReferenceInterciti.Vehiculo();
                recorrido.IdVehiculo = clienteQuery.IdVehiculo;
                //     recorrido.Vehiculos =client.FindVehiculoByID( clienteQuery.IdVehiculo);
                recorrido.Modelo1 = clienteQuery.Modelo;
                recorrido.Año1 = clienteQuery.Año;
                recorrido.Tipo1 = clienteQuery.Tipo;
        ...
        public static ServiceReferenceInterciti.Cliente AppToWCF(Models.Cliente idCliente)
        {
            throw new NotImplementedException();
        }

        public static Models.Conductor GetUser(string nombre, string pass, int idVehiculo, string apellido, string cedula, string correo, string telefono, DateTime fechaNacimiento, bool estado, string token, byte[] pic)
        {

            Models.Conductor cliente = new Models.Conductor();
            ...
            cliente.EstadoConductor = estado;
        ...
        public static Models.Recorrido WCFToApp(ServiceReferenceInterciti.Recorrido clienteQuery)
        {
            ...
            if (clienteQuery != null)
            {
                recorrido = new AppTesisTestConductor.Models.Recorrido();
                recorrido.IdCliente =WCFToApp( clienteQuery.IdCliente);
                
                if (clienteQuery.IdConductor!=null)
                {
                    recorrido.IdConductor = new Models.Conductor { Nombre = "Nueva Solicitud", IdConductor = 0 };
                //WCFToApp(clienteQuery.IdConductor);
        ...
        public static Models.TipoVehiculo WCFToApp(ServiceReferenceInterciti.TipoVehiculo clienteQuery)
        {
            ...
            if (clienteQuery != null)
            {
                recorrido = new AppTesisTestConductor.Models.TipoVehiculo();
        ...
        public static AppTesisTestConductor.Models.Conductor WCFToApp(ServiceReferenceInterciti.Conductor clienteQuery)
        {
            AppTesisTestConductor.Models.Conductor recorrido = null;
            if (clienteQuery != null)
            {
                recorrido = new AppTesisTestConductor.Models.Conductor();
                recorrido.IdConductor =clienteQuery.IdConductor;
        ...
        public static AppTesisTestConductor.Models.Cliente WCFToApp(ServiceReferenceInterciti.Cliente clienteQuery)
        {
            AppTesisTestConductor.Models.Cliente recorrido = new Models.Cliente();
            if (clienteQuery != null)
            {
                recorrido = new AppTesisTestConductor.Models.Cliente();
        ...
        public static Models.Vehiculo WCFToApp(ServiceReferenceInterciti.Vehiculo clienteQuery)
        {
            ...
            if (clienteQuery != null)
            {
                ...
                recorrido.Picture.Source = ImageSource.FromStream(() =>
                {
                    if (clienteQuery.Picture != null)
                    {
                        return new MemoryStream(Servicio.Decompress( clienteQuery.Picture));
                    }
                    return null;
                });
                //   recorrido.Mensajes = cli
        ...
        {
            List<Models.Recorrido> recorrido = null;
            if (clienteQuery != null)
            {
                recorrido = new List<Models.Recorrido>();
